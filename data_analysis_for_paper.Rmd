...
cells$d6_sce <- as.SingleCellExperiment(cells$d6)
cells$d12_sce <- as.SingleCellExperiment(cells$d12)
cells$ctrl6d_sce <- as.SingleCellExperiment(cells$ctrl6d)
...
reducedDim(cells$ctrl6d_sce, "UMAP")[, 2] <- (-1) * reducedDims(cells$ctrl6d_sce)$UMAP[, 2]
...
sshot_6d <- slingshot(cells$d6_sce, Idents(cells$d6),
                      reducedDim = "HARMONY", start.clus = "Basal")
sshot_12d <- slingshot(cells$d12_sce, Idents(cells$d12),
                       reducedDim = "HARMONY", start.clus = "Basal")

sshot_ctrl6d_separate <- slingshot(cells$ctrl6d_sce,
                                   Idents(cells$ctrl6d),
...
umap_curve_6d <- slingCurves(embedCurves(sshot_6d,
                                         reducedDims(cells$d6_sce)$UMAP))[[1]]
umap_curve_12d <- slingCurves(embedCurves(sshot_12d,
                                          reducedDims(cells$d12_sce)$UMAP))[[1]]
