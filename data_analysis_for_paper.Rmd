...
pass_qc <- c()
for (j in 1:length(skin_data$orig.ident)) {
...
legend_plot <- ggplot(data.frame(class = as.character(1:length(labels)),
                                 x = 1:length(labels)),
...
vol_6d_legend <- ggplot(data.frame(class = as.character(1:length(labels)),
                                   x = 1:length(labels)),
    ...
    p <- ggplot() +
         ...
         scale_color_manual(labels = c("Holoclone-forming",
                           ...
                           values = c("#80C9EA", "#DD6E79",
                                      "#43863E", "#BBBBBB")) +
         geom_path(data = curve_df[1:end_idx, ],
                   aes(x = u1, y = u2),
         ...
         geom_path(data = curve_df[1:2, ],
                   ...
                   size = arrow_width) +
         geom_path(data = curve_df[1:basal_pct_overall_idx, ],
                   aes(x = u1, y = u2),
                   arrow = arrow(type = "closed", length = arrowhead_length),
                   size = arrow_width) +
         geom_path(data = curve_df[1:ta_pct_overall_idx, ],
                   aes(x = u1, y = u2),
                   arrow = arrow(type = "closed", length = arrowhead_length),
                   size = arrow_width) +
