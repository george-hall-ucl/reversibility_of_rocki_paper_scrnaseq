...
```{r results = 'markup'}
# Generate bootstrapped data as in "experiment_code_trajectories.R", then
# convert the output to csv using Python:
# import sys
...
#             rejoin = ",".join(splat[1:])
#             print(rejoin[1:-1])
# and save as "trajectory_comparison_results.csv". Then:
bootstrap_results <- read.csv("trajectory_comparison_results.csv", header = FALSE,
